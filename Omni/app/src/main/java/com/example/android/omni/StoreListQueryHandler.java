...
public class StoreListQueryHandler {
    ...
    static double userLat = StoreListActivity.userLat;
    static double userLon = StoreListActivity.userLon;
...
//            urlConnection.setRequestProperty("user-key", " "+API_KEY);
    ...
    private static List<StoreListModel> extractFeatureFromJson(String StoresJSON) {

        List<StoreListModel> Store = new ArrayList<>();
        ...
        try {
            ...
            for (int i = 0; i < storelist.length(); i++) {
                ...
                StoreListModel store = new StoreListModel(R.drawable.woodland, storeName, area, openingTime, closingTime, dist, 100, men, women, kids);
                Store.add(store);
        ...
        Log.e("QueryUtils", "This is the Array ");
        return Store;
    }
    ...
    public static List<StoreListModel> fetchStoreData(String requestUrl) {
